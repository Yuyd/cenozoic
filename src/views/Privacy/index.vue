  ...
  <div class="PrivacyPolicy">
    <div class="center">
      ...
      <li>
        ...
        Agreement) refers to: Che Dao Limited from Cayman Islands.
      </li>
      <li>
        <b>● Cookies</b>
      ...
      <p>
        While using Our Service, We may ask You to provide Us with certain data
      ...
      <li>
        <b>●</b>
        Prevent or investigate possible wrongdoing in Our Service
      </li>
      <li>
        <b>●</b>
