const es = {
  ...
  home: {
    ...
    homeGameContent2: "Los tokens respaldados por activos dentro del protocolo Cenozoic se utilizan para la fijación de precios de activos, pagos y liquidaciones dentro del juego.",
    homeGovernance: 'ZOIC',
    homeGovernanceContent: "El token de gobernanza del protocolo Cenozoic también sirve como Prueba de Trabajo de Juego (PoGW) para los jugadores.",
    homeVeZOIC: 'veZOIC',
    ...
    homeEarnContent: "Extrae CENO y obtén recompensas ZOIC mediante la quema de NFT. Quemar CENO y ZOIC proporcionalmente permite el canje de activos en la tesorería.",
    homeReceiveTit: 'Obtener veZOIC para aumentar las recompensas del juego.',
    homeReceiveContent: 'Obtén veZOIC al bloquear ZOIC para aumentar el multiplicador de recompensas de ZOIC dentro del juego.',
