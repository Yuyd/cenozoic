const ko = {
  ...
  home: {
    ...
    homeGovernance: 'ZOIC',
    homeGovernanceContent: "Cenozoic 프로토콜의 거버넌스 토큰은 플레이어의 게임 작업 증명 (PoGW)으로도 사용됩니다.",
    homeVeZOIC: 'veZOIC',
    ...
    homeEarnContent: "NFT를 소각하여 CENO를 추출하고 ZOIC 보상을 받을 수 있습니다. CENO와 ZOIC를 비례하여 소각하면 금고의 자산을 교환할 수 있습니다.",
    homeReceiveTit: '게임 보상 증대를 위한 veZOIC 획득',
    homeReceiveContent: 'ZOIC를 스테이킹하여 veZOIC을 획득하여 게임 내 ZOIC 보상 배율을 증가시킵니다.',
