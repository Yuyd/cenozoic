const pt = {
  ...
  home: {
    ...
    homeInteroper: 'Interoperabilidade:',
    homeInteroperContent: 'Cenozoic oferece uma camada econômica e de negociação compartilhada composta por moedas estáveis de jogos e tokens de governança, e os ativos em jogos suportados pelo protocolo são intercambiáveis, com interoperabilidade.',
    homeBuilding: 'Construindo reputação na cadeia para jogadores Web3:',
    homeBuildingContent: 'Jogar é construir. Os dados do jogo gerados pelos jogadores em jogos on-chain são armazenados permanentemente na blockchain e são exibidos como NFTs no protocolo, ajudando os jogadores a construir sua própria reputação na cadeia.',
    homeCoMpos: 'Componibilidade:',
    homeCoMposContent: 'Nos jogos on-chain da Cenozoic, as regras básicas são restritas, mas qualquer jogador ou desenvolvedor pode construir novas regras de jogo e criar novos mapas sem permissão, personalizando os jogos e desencadeando verdadeiros jogos Web3.',
    homeTranspraent: 'Mecanismo de governança DAO transparente e justo:',
    homeTranspraentContent: 'A Cenozoic opera por meio de um mecanismo de governança DAO. Todos os jogadores, desenvolvedores e equipes que possuem tokens de governança ZOIC podem garantir o direito de governança do Cenozoic DAO, decidindo sobre atualizações, modificações, governança, etc. do protocolo.',
    homeCenoTit: 'CENO&ZOIC',
    homeGame: 'Moeda estável do jogo: CENO',
    homeGameContent1: '100 CENO ≈ 1 USDT',
    homeGameContent2: 'CENO é uma criptomoeda com garantia de ativos usada para precificação, pagamento e liquidação de ativos no jogo. Os usuários precisam depositar USDT ou USDC para criar a correspondente relação 1:100 de CENO, que pode ser resgatado a qualquer momento.',
    homeGovernance: 'Token de governança e prova de trabalho do jogo: ZOIC',
    homeGovernanceContent: 'ZOIC é o token de governança do protocolo Cenozoic e também a prova de trabalho dos jogadores, produzido em forma de PoW como recompensa para os jogadores.',
    homeVeZOIC: 'veZOIC',
