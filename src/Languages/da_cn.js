const da = {
  ...
  home: {
    ...
    homeGameContent2: "De aktiebaserede tokens inden for Cenozoic-protokollen bruges til prissætning, betaling og afvikling af aktiver i spillet.",
    homeGovernance: 'ZOIC',
    homeGovernanceContent: "Governancetokenet i Cenozoic-protokollen fungerer også som Bevis for Spilarbejde (PoGW) for spillerne.",
    homeVeZOIC: 'veZOIC',
    ...
    homeEarnContent: "Udtræk CENO og optjen ZOIC-belønninger ved at brænde NFT'er. Ved at brænde CENO og ZOIC proportionalt kan man indløse aktiver i kassen.",
    homeReceiveTit: 'Få veZOIC for øgede spilbelønninger',
    homeReceiveContent: 'Opnå veZOIC ved at stake ZOIC for at øge belønningsmultiplikatoren for ZOIC inden for spillet.',
